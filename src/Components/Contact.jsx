...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_cp513ug", "template_gpux0i1", formref.current, {
        publicKey: "ixs2PsoF9milGUXuQ",
      })
      .then(
        () => {
          setSuccess(true);
        ...
        <div className="w-1/2 items-center md:items-start flex-col md:flex:row flex">
          ...
          <span className="text-sm font-palanquin">
            <a
              ...
              target="_blank"
            >
              www.linkedin.com/in/naveen-kumar-473006218
            </a>
          </span>
        </div>
        <div className="w-1/2 items-center md:items-start flex-col md:flex:row flex">
          <h2 className="font-semibold font-montserrat">Phone Number</h2>
          <span className="text-sm font-palanquin ">+91 6379617916 </span>
        </div>
      </div>
